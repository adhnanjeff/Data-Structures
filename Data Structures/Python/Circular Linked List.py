...
if __name__ == "__main__":
    ...
    while True:
        ...
        if choice == 1:
            ...
            circular_linked_list.insert_beginning(value)
        elif choice == 2:
            circular_linked_list.delete_beginning()
        elif choice == 3:
            value = int(input("Enter the value to insert: "))
            circular_linked_list.insert_end(value)
        elif choice == 4:
            circular_linked_list.delete_end()
        elif choice == 5:
            value = int(input("Enter the value to insert: "))
            position = int(input("Enter the position to insert: "))
            circular_linked_list.insert_at_position(value, position)
        elif choice == 6:
            position = int(input("Enter the position to delete: "))
            circular_linked_list.delete_at_position(position)
        elif choice == 7:
